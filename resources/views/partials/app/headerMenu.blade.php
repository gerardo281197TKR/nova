    ...
    <div class="top-navbar-right ms-auto">
        ...
        <li class="nav-item dropdown dropdown-user-setting">
            ...
            <div class="user-setting">
                <img src="/template/assets/images/avatars/06.png" class="user-img" alt="">
            </div>
            </a>
            ...
            <li>
                ...
                <div class="d-flex flex-row align-items-center gap-2">
                    <img src="/template/assets/images/avatars/06.png" alt="" class="rounded-circle" width="54" height="54">
                    <div class="">
